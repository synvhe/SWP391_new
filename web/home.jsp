...
<html lang="en">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
        ...
        <div class="offcanvas-header justify-content-between">
            <h4 class="fw-normal text-uppercase fs-6">Category</h4>
            ...
            <c:forEach items="${listCate}" var="lc">
                <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    <li class="nav-item border-dashed active">
                        <a href="home?categoryId=${lc.categoryId}" class="nav-link d-flex align-items-center gap-3 text-dark p-2">            
                            <span>${lc.name}</span>
                        </a>
                    </li>
                </c:forEach>
            ...
            <div class="row py-3 border-bottom align-items-center">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="search-bar bg-light p-2 rounded-4 d-flex align-items-center">
                        <form id="search-form" class="flex-grow-1" action="home" method="post">
                ...
                <div class="col-lg-4">
                    <ul class="navbar-nav list-unstyled d-flex flex-row gap-4 justify-content-center align-items-center mb-0 fw-bold text-uppercase text-dark">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle pe-3" role="button" id="pages" data-bs-toggle="dropdown" aria-expanded="false">
                                Pages
                            </a>
                ...
                <div class="col-sm-8 col-lg-2 d-flex gap-4 align-items-center justify-content-center justify-content-sm-end">
                    <ul class="d-flex justify-content-end list-unstyled m-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu border-0 p-3 rounded-0 shadow" aria-labelledby="userMenu">
                                ...
                                <c:if test="${sessionScope.account != null}">
                                    ...
                                    <li><a href="profile.jsp" class="dropdown-item">Profile</a></li>
                                    <li><a href="orders.jsp" class="dropdown-item">My Cart</a></li>
                        ...
                        <li>
                            <a  class="p-2" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                                <svg width="24" height="24">
                                <use xlink:href="#shopping-bag"></use>
                                </svg>
                                <a href="cart.jsp">${size}</a> 
                            </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="card-body p-0">
                                    ...
                                    <p class="card-text">Khu Vực TP Hà Nội.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5">
                            <c:forEach items="${products}" var="p" begin="0" varStatus="status">
                                <div class="col product-item ${status.index >= 10 ? 'd-none' : ''}">
                                    <div class="product-item">
                                        ...
                                        <div class="d-flex flex-column text-center">
                                            ...
                                            <div class="button-area p-3 pt-0">
                                                <form name="f${p.productId}" action="addtocart" method="post">
                                                    <input type="hidden" name="id" value="${p.productId}">
                                                    <div class="row g-1 mt-2">
                                                        <div class="col-3">
                                                            <input type="number" name="num" class="form-control border-dark-subtle input-number quantity" value="1" min="1">
                                                        </div>
                                                        <div class="col-7">
                        ...
                        <div class="text-center mt-4">
                            <button class="btn btn-outline-primary" id="viewAllButton">View All Products</button>
                            <button class="btn btn-outline-secondary d-none" id="collapseButton">Collapse</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="banner-ad d-flex align-items-center large bg-info block-1" style="background: url('images/banner-ad-1.jpg') no-repeat; background-size: cover;">
                        <div class="banner-content p-5">
                            <div class="content-wrapper text-light">
                                <h3 class="banner-title text-light">Sản phẩm đang được giảm giá</h3>
                                <p>Giảm giá tới 30%</p>
            ...
            <div class="col-md-12">
                ...
                <div class="section-header d-flex flex-wrap justify-content-between my-4">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="#" class="btn btn-primary me-2">Xem Thêm</a>
...
<script>
                    ...
                    viewAllButton.addEventListener('click', function () {
                        document.querySelectorAll('.product-item.d-none').forEach(item => item.classList.remove('d-none'));
 ...
 <script type="text/javascript">
                    function addtocart(productId) {
                        document.f.action = "addtocart?id=" + productId;
                        document.f.submit();
                    }
                </script>
</body>
